...
namespace HSS.System.V2.DataAccess.Contexts
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<MedicalLabTestResultFieldValue> MedicalLabTestResultFieldValues { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MedicalLabTestResultFieldValue>()
                .HasOne(c => c.Appointment)
                .WithMany(a => a.TestResultFieldValues)
