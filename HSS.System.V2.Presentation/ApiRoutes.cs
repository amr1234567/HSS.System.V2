...
public static class ApiRoutes
{
    ...
    {
        public const string Base = "api/medical-lab";

        public const string EndAppointment = Base + "/appointments/{appointmentId}/end";
        public const string AddMedicalLabTestResult = Base + "/appointments/{appointmentId}/result";
        public const string GetTestResultFields = Base + "/tests/{testId}/fields";
        public const string GetCurrentMedicalLabAppointment = Base + "/appointments/{appointmentId}";
        public const string GetQueueForMedicalLab = Base + "/queue";
    }
}